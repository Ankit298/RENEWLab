...
def convert_channel_dimensions_single(csi,zero_subcarrier_indices):
    """
    ...
    for frame in range(frames):
        channel[frame] = csi[frame,0,0,first_non_zero_subcarrier]
...
def convert_transmit_dimensions_single(filepath,frames,total_subcarriers = 64):
    """
